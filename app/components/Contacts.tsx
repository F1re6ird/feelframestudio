        ...
        <div className='min-h-fit w-full'>
            ...
            <div className='flex max-sm:flex-col items-center sm:gap-8 gap-2  h-fit w-full justify-center px-2 my-28'>
                <a href={loading ? "" : data.instagramLink} target="_blank" rel="noreferrer">
                    <div className='flex items-center justify-center gap-4'><FaInstagram className='fill-[#f5f5f5] hover:fill-[#d85425] hover:scale-90 transition-all ease-in duration-100' size={35} /></div>
                </a>
                ...
                <a href={loading ? "" : data.youtubeLink} target="_blank" rel="noreferrer">
                    <div className='flex items-center justify-center gap-4'>
                        <FaYoutube className='fill-[#f5f5f5] hover:fill-[#d85425] hover:scale-90 transition-all ease-in duration-100' size={35} /></div>
                </a>
            </div>
